...
class MonteCarloAgent(ELAgent):
    ...
    def learn(self,
        ...
        # 各个state下各个action的行动次数, 为了计算平均价值
        ...
        for e in range(episode_count):
            ...
            # 进行游戏, 直到回合结束
            experience = []  # 记录一个回合的所有经验[(s1,a1,r1), (s2,a2,r2), ...]
            ...
            for i, x in enumerate(experience):
                ...
                # 计算状态s对应的折现值(要注意这里从时间步i开始计算)
                # 我们是用当前的时间步作为起点来计算G, 这个称为Every-visit;
                # 也有按照(s, a)首次出现的时间步作为起点开始计算的, 叫做First-visit
                G, t = 0, 0
            ...
            if e != 0 and e % report_interval == 0:
                self.show_reward_log(episode=e)  # print
