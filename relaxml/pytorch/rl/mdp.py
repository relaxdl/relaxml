...
class Environment():
    ...
    def reward_func(self, state):
        ...
        当状态为绿色格子的时候, 奖励是1; 当状态是红色格子的时候, 奖励是-1. 除此之外
        都返回默认的奖励default_reward, default_reward的值会对agent的行为产生影响,
        我们这里设置为一个负数, 如果agent乱走, 奖励会逐渐变小, 这个值可以起到加快行动
        的效果, 这也说明了奖励的设置会对强化学习结果产生很大影响 
