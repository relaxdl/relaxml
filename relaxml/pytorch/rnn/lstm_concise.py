...
实现说明:
https://tech.foxrelax.com/rnn/lstm_concise/
"""
...
class RNNModel(nn.Module):
    ...
    >>> assert new_state[0].shape == ((2 if bidirectional else 1) * num_layers,
                                       batch_size, num_hiddens)
    >>> assert new_state[1].shape == ((2 if bidirectional else 1) * num_layers,
                                       batch_size, num_hiddens)
    """
...
if __name__ == '__main__':
    run()
# 困惑度 1.2, 254932.3 词元/秒 cuda:0
# time traveller with his mouth full nodding hisheadi d give a shi
# traveller s white and more splendid cries of the hard with
