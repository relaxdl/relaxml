...
实现说明:
https://tech.foxrelax.com/rnn/rnn_concise/
"""
...
if __name__ == '__main__':
    run()
# 困惑度 2.3, 526131.3 词元/秒 cuda:0
# time traveller amidist it was a mear the tumnotice a lyou hop i
# traveller alood the fate fistrat issackeses and the curtain
